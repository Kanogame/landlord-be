...
namespace landlord_be.Data {
    public class DbInitializer {
        ...
        {
            new User { Name = "Иван Иванов", PasswordHash = "hash1", Token = "token1", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Петр Петров", PasswordHash = "hash2", Token = "token2", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Сергей Сергеев", PasswordHash = "hash3", Token = "token3", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Алексей Алексеев", PasswordHash = "hash4", Token = "token4", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Дмитрий Дмитриев", PasswordHash = "hash5", Token = "token5", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Анна Антонова", PasswordHash = "hash6", Token = "token6", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Мария Маркова", PasswordHash = "hash7", Token = "token7", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Елена Еленина", PasswordHash = "hash8", Token = "token8", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Олег Олегов", PasswordHash = "hash9", Token = "token9", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now },
            new User { Name = "Татьяна Татьянова", PasswordHash = "hash10", Token = "token10", RegisterDate = DateTime.Now, UpdateDate = DateTime.Now }
        };
