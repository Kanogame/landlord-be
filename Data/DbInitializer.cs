        ...
        public async Task Initialize(ApplicationDbContext context)
        {
            ...
            var properties = new List<Property>
            {
                ...
                new Property
                {
                    ...
                    Name = "Студия",
                    Desc =
                        "Сдаю современную квартиру с дизайнерским ремонтом в деловом районе. Большие окна дарят много света, а панорамный вид на город создает неповторимую атмосферу. В шаговой доступности крупные торговые центры, офисные здания и деловые клубы. Отличный вариант для молодых профессионалов.",
                ...
                new Property
                {
                    ...
                    Desc =
                        "Предлагается уютная квартира с обновленным интерьером в центре большого города. Просторная кухня, стильная гостиная и удобные спальни помогут создать атмосферу домашнего уюта. Рядом с домом расположены парки и транспортная развязка, что позволяет легко добраться до любой точки города",
                ...
                new Property
                {
                    ...
                    Name = "Дача",
                    Desc =
                        "Предлагаю в аренду дачу с живописным видом на озеро, где можно насладиться спокойствием и природной красотой. Дом выполнен в классическом стиле с просторной террасой, оборудован современной сантехникой и отоплением на дровах. Идеальное место для летних каникул, творческих встреч и семейных праздников.",
                ...
                new Property
                {
                    ...
                    Desc =
                        "Продам современную квартиру с открытой планировкой и качественным ремонтом в новом жилом комплексе. Высокие потолки, балкон и просторные комнаты порадуют даже самых взыскательных арендаторов. Дом оборудован системами безопасности и рядом с ним находятся все необходимые объекты инфраструктуры",
                ...
                new Property
                {
                    ...
                    Desc =
                        "Аренда уютной квартиры в центре с недавним ремонтом и всеми современными удобствами. Отличная планировка, светлые комнаты, и отдельная кухонная зона создают пространство для творчества. Рядом множество кафе, магазинов и зеленых аллей, где можно насладиться утренним кофе.",
                ...
                new Property
                {
                    ...
                    Name = "Коттедж",
                    Desc =
                        "Продам в аренду современный коттедж в элитном загородном поселке. Дом имеет уникальный архитектурный стиль, большое количество стеклянных элементов, что обеспечивает обилие естественного освещения. Просторный участок с ландшафтным дизайном, беседка и бассейн – всё для комфортного проживания и отдыха.",
                ...
                new Property
                {
                    ...
                    Desc =
                        "Сдается в аренду красивая квартира на среднем этаже с ремонтом премиум-класса. Интерьер выполнен в современном стиле, используются качественные материалы и техника. Расположение квартиры в историческом районе с насыщенной культурной жизнью подчеркнет ваш утонченный вкус",
                ...
                new Property
                {
                    ...
                    Name = "Квартира в новостройке",
                    Desc =
                        "Сдам в аренду уютное жилье в центре со свежим ремонтом и функциональной планировкой. Просторная гостиная с большими окнами, современная кухня и комфортабельные спальни – всё для вашего удобства. Район развитой инфраструктуры с магазинами, парками и транспортными узлами",
                ...
                new Property
                {
                    ...
                    Desc =
                        "Предлагаю в аренду светлую и просторную квартиру с обновленным интерьером в престижном районе. Высокое качество отделки, встроенные шкафы и современные системы отопления подарят комфорт в любое время года. Вокруг – развитая сеть кафе, магазинов и зон отдыха.",
                ...
                new Property
                {
                    ...
                    Name = "Деревянный дом",
                    Desc =
                        "Продаю деревянный дом с ремонтами под ключ в живописном месте. Дом представляет собой сочетание классического и модернистского стилей: светлые комнаты, современная кухня и санузлы с новой сантехникой. Идеальное место для постоянного проживания или сезонного отдыха в окружении природы",
            ...
            {
                _logger.LogError($"Error saving properties: {ex.Message}");
            ...
            Console.WriteLine(savedProperties.Count);
            ...
            string[][] imageList =
            {
                ...
                [
                    "public/images/commercial/3_1.webp",
                    "public/images/commercial/3_2.webp",
                    "public/images/commercial/3_3.webp",
                    "public/images/commercial/3_4.webp",
                    "public/images/commercial/3_5.webp",
                ],
                [
                    "public/images/commercial/4_1.webp",
                    "public/images/commercial/4_2.webp",
                    "public/images/commercial/4_3.webp",
                    "public/images/commercial/4_4.webp",
                ],
            };
            ...
            for (int i = 0; i < savedProperties.Count; i++)
            {
                ...
                {
                    var images = imageList[i];
                    for (int j = 0; j < images.Length; j++)
                    {
                        imageLinks.Add(
                            new ImageLink { PropertyId = savedProperties[i].Id, Link = images[j] }
                        );
                    }
                }
            }
